 ...
 */
public class Adapter_Duration  extends BaseAdapter {
    ...
    public Adapter_Duration(Context context, List<Data_Value_Detail_Numbered> initdatalist) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        holder.Address.setText(""+initdatalist.get(position).getTarget()+" Menit");
        holder.Channel.setText(initdatalist.get(position).getProcent());
        holder.Procent.setText(""+initdatalist.get(position).getTarget());


        if (((Float.parseFloat(initdatalist.get(position).getTarget()))>=0f)&&((Float.parseFloat(initdatalist.get(position).getTarget()))<120f)){
            Picasso.get().load(R.drawable.circle_red).into(holder.Img);
        }else if (((Float.parseFloat(initdatalist.get(position).getTarget()))>=120f)&&((Float.parseFloat(initdatalist.get(position).getTarget()))<=180f)){
