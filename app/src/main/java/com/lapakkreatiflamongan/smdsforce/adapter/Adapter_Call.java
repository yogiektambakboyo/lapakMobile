 ...
 */
public class Adapter_Call  extends BaseAdapter {
    ...
    public Adapter_Call(Context context, List<Data_Value_Detail_Numbered> initdatalist) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (((Float.parseFloat(clockFloat.replace(":","")))>815f)){
        ...
        }else if ((((Float.parseFloat(clockFloat.replace(":","")))>=745f)&&((Float.parseFloat(clockFloat.replace(":","")))<=815f))){
